...
# ==========================================================================
# 2. Define a função principal para indexação dos documentos
# ==========================================================================
...
def main_indexing(mypath):
    ...
    lista_arquivos_ = lista_arquivos(mypath)
